const cvData = {
  ...
  de: {
    ...
    experience: [
      {
        ...
        duration: "Sept 2023 - März 2025",
        description:
          "Ich entwickelte eine Bildungs-Handelsplattform für Märkte wie Spot, MMK und Forward, die für hohe Transaktionsvolumina ausgelegt ist. Ich trug auch zu mehreren Webprojekten bei und baute skalierbare, leistungsstarke APIs mit Node.js und NestJS.",
      },
      {
        company: "Fentech",
        position: "Softwareentwickler",
        duration: "Sept 2023 - März 2024",
        description:
          "Ich entwickelte robuste APIs mit Python und FastAPI, verwaltete Daten mit PostgreSQL und half beim Entwurf einer verteilten Microservices-Architektur zur Verbesserung der Skalierbarkeit und Resilienz.",
      },
      {
        company: "Freelance",
        position: "Tech Lead",
        duration: "Dauer --> 3 Monate (2025)",
        description:
          "Ich arbeitete am Backend eines Schmuck-E-Commerce-Shops mit NestJS und PostgreSQL, verwaltete Produktlisten, Bestellungen und Zahlungen. Ich war auch für die Bereitstellung der Plattform auf einem VPS mit Docker verantwortlich und stellte ein reibungsloses und zuverlässiges Einkaufserlebnis sicher.",
      },
      {
        company: "Freelance",
        position: "Full Stack Entwickler",
        duration: "Dauer --> 3 Monate (2023)",
        description:
          "Ich erstellte eine Suchplattform für Ärzte und Apotheker und kümmerte mich sowohl um das Frontend als auch um das Backend mit HTML, CSS, JavaScript, jQuery und PHP.",
      },
    ],
    education: [
      {
        ...
        expertise: [
          {
            category: "Allgemeine Informatik und KI",
            details:
              "Fortgeschrittene Algorithmen, Komplexität, Datenbanken, Problemlösung, Wissensrepräsentation und maschinelles Lernen",
          },
          {
            category: "Visuelle Datenverarbeitung",
            details:
              "Bild- und Videoanalyse, Datenvisualisierung, Entwicklung von Multimedia-Anwendungen",
          },
        ],
      },
      {
        degree:
          "Bachelor-Abschluss in Informationssystemen und Softwaretechnik",
        duration: "Sep 2017 - Jul 2020",
        institution: "USTHB, ALGER",
        expertise: [
          {
            category: "Grundlagen der Informatik",
            details: "Starke Grundlagen in Informatik, Software und Hardware",
          },
          {
            category: "Grundprinzipien & Netzwerke",
            details:
              "Solides Verständnis der Kernkonzepte und Netzwerktechnologien",
          },
          {
            category: "Organisatorisches Wissen",
            details:
              "Kenntnisse in Organisationsstrukturen, Management und Informationssystemen",
          },
          {
            category: "Entwicklung von Informationssystemen",
            details:
              "Fähigkeiten im gesamten Entwicklungszyklus mit modernen Methoden und Datenbankmanagement",
          },
          {
            category: "Softwareentwicklung & Testen",
            details:
              "Kompetenz in Softwareentwicklung und gründlichen Testverfahren",
          },
        ],
      },
    ],
    skills: {
      technical: [
        "Full Stack Web Entwicklung (hauptsächlich Backend)",
        "RESTful & GraphQL API Entwicklung",
        "Desktop Entwicklung (hauptsächlich Windows/Linux)",
        "Mobile Entwicklung (hauptsächlich Android)",
        "SQL/NoSQL Datenbanken (PostgreSQL, MySQL, MongoDB)",
        "Verteilte Systeme & Microservices Architektur",
        "Containerisierung & Bereitstellung (Docker, VPS)",
        "CI/CD & DevOps Grundlagen",
        "Softwarearchitektur & Design",
        "Echtzeit-Datenverarbeitung (WebSockets, Pub/Sub)",
        "Datenanalyse & -verarbeitung",
        "Authentifizierung & Autorisierung (JWT, OAuth)",
...
function populateExperience(data) {
  ...
  experienceSection.innerHTML = `
    <div class="experience-subsection">
      <h2><i class="fas fa-building me-2"></i>${
        currentLanguage === "en"
    ...
    <div class="experience-subsection">
      <h2><i class="fas fa-user-tie me-2"></i>${
        currentLanguage === "en"
          ? "Experience as a Freelancer"
          : "Erfahrung als Freiberufler"
      }</h2>
...
function populateEducation(data) {
  ...
  educationSection.innerHTML = `
    <h2><i class="fas fa-graduation-cap me-2"></i>${
      currentLanguage === "en" ? "Education" : "Bildung"
    }</h2>
    ${data.education
      .map(
        (edu) => `
...
function populateSkills(data) {
  ...
  skillsSection.innerHTML = `
    <h2><i class="fas fa-tools me-2"></i>${
      currentLanguage === "en" ? "Technical Expertise" : "Technische Expertise"
    }</h2>
...
function toggleLanguage() {
  ...
  langToggle.innerHTML = `
    <span class="flag-icon flag-icon-us" style="display: ${
      currentLanguage === "en" ? "inline-block" : "none"
    }"></span>
    <span class="flag-icon flag-icon-de" style="display: ${
      currentLanguage === "de" ? "inline-block" : "none"
    }"></span>
  `;
  populateContent();
}
...
function populateContent() {
  const data = cvData[currentLanguage];
...
function init() {
  ...
  langPopup.className = "lang-popup";
  langPopup.style.display = "none";
  langPopup.style.position = "fixed";
  langPopup.style.top = "70px";
  langPopup.style.left = "20px";
  langPopup.style.zIndex = "1000";
  langPopup.style.background = "var(--primary)";
  langPopup.style.padding = "10px";
  langPopup.style.borderRadius = "5px";
  langPopup.style.boxShadow = "0 2px 5px rgba(0,0,0,0.2)";
  langPopup.innerHTML = `
    <div style="cursor: pointer; padding: 5px;" onclick="setLanguage('en')">
      <span class="flag-icon flag-icon-us"></span> English
    </div>
    <div style="cursor: pointer; padding: 5px;" onclick="setLanguage('de')">
  ...
  langToggle.style.boxShadow = "0 2px 5px rgba(0,0,0,0.2)";
